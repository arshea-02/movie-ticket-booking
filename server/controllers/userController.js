...
const postSignup =  async (req, res)=>{
    ...
    try{
        ...
        const verify = await sendVerificationEmail(user.email, verificationToken);
...
const postLogin = async (req, res)=>{
    ...
    if(forgotPassword){
        ...
        if(response){
            //req.method = 'PUT';    cannot set headers 
...
export default { postSignup, postLogin, forgetPassword, resetPassword, updateUser, delUser, logout }